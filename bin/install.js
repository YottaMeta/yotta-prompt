#!/usr/bin/env node
/**
 * @yottameta/yotta-prompt cross-platform installer.
 *
 * Usage:
 *   npx -y @yottameta/yotta-prompt --agent <name>
 *   npx -y @yottameta/yotta-prompt --dir <path>
 *   npx -y @yottameta/yotta-prompt -g
 *   npx -y @yottameta/yotta-prompt
 *   npx -y @yottameta/yotta-prompt --list
 */
'use strict';
...
function usage() {
  console.log('yotta-prompt installer');
  console.log('');
  console.log('Usage:');
  console.log('  npx -y @yottameta/yotta-prompt --agent <name>  Install to an agent default directory');
  console.log('  npx -y @yottameta/yotta-prompt --dir <path>     Install to a custom directory');
  console.log('  npx -y @yottameta/yotta-prompt -g               Install to all known agent directories');
  console.log('  npx -y @yottameta/yotta-prompt                  Auto-detect project-level directories');
  console.log('  npx -y @yottameta/yotta-prompt --list           List supported agent directories');
  console.log('');
  console.log('Options:');
